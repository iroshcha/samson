...
use Bitrix\Main\Page\Asset; 
 Asset::getInstance()->addJs("/js/jquery-1.8.2.min.js"); 
 Asset::getInstance()->addJs("/js/slides.min.jquery.js"); 
 Asset::getInstance()->addJs("/js/jquery.carouFredSel-6.1.0-packed.js"); 
 Asset::getInstance()->addJs("/js/functions.js"); 
 ?>
